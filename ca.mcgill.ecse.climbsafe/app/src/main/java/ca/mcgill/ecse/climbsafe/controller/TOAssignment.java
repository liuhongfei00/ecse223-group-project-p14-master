...
public class TOAssignment
{
  ...
  public TOAssignment(String aMemberEmail, String aMemberName, String aGuideEmail, String aGuideName, String aHotelName, String aAuthCode, int aStartWeek, int aEndWeek, int aTotalCostForGuide, int aTotalCostForEquipment)
  {
